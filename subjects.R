...
d = read_csv("/Volumes/data_gabriella_chronis/feature_prediction_stuff/features_in_context_data/processed/swapped_subject_and_object_predictions_ffnn.csv") %>%
  filter(
...
bind = read_csv("/Volumes/data_gabriella_chronis/feature_prediction_stuff/features_in_context_data/processed/binder_feature_names.csv") %>%
